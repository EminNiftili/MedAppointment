...
{
    public abstract class BaseWeeklySchemaWriteValidation<TModel> : BaseValidator<TModel> where TModel : BaseWeeklySchemaDto
    {
        ...
        protected BaseWeeklySchemaWriteValidation()
        {
            RuleFor(x => x.Name)
                .NotEmpty()
